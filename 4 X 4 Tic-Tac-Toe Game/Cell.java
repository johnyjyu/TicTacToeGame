...
public class Cell {
   ...
   private final int row, col; // numbers of row and column of this cell
 
   /** Constructor to initialize this cell with the specified row and col and empty content*/
   public Cell(int row, int col) {
      this.row = row;
      this.col = col;
      content = Seed.EMPTY; // clear content
   }
