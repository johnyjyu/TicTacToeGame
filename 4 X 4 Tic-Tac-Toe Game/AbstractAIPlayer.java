 ...
 * Assume that next move is available when not game-over yet.
 */
public abstract class AbstractAIPlayer {
   ...
   protected Cell[][] cells; // the board's ROWS-by-COLS 2D array of Cells
   protected Seed mySeed;    // computer's seed
   protected Seed oppSeed;   // opponent's seed
   // protected int depthLimit; // depth searched by computer
